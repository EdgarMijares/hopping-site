<?php
	...
	$dataquery = "UPDATE places SET placename='$placename', description='$description', contactnumber='$contactnumber', latitude='$latitude', longitude='$longitude' WHERE id_place='$id_place'";
	$_SESSION['save-pending'] = true;
